...
const ProductDetails = ({ params }) => {
  ...
  const { image, price, title, description } = dataProduct || {};
      ...
      <div className="product-detail-container">
        ...
        <div className="product-detail-desc">
          ...
          <div className="buttons">
            <button type="button" className="add-to-cart select-none" onClick={() => onAdd(dataProduct, qty)}>Ajouter au panier</button>
